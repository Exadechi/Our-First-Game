...
if __name__ == "__main__":
    ...
    class UnitTestVector(unittest.TestCase):
        ...
        def testMath(self):
            v = Vector(111,222)
            self.assertEqual(v + 1, Vector(112,223))
            self.assert_(v - 2 == [109,220])
            self.assert_(v * 3 == (333,666))
            self.assert_(v / 2.0 == Vector(55.5, 111))
            self.assert_(v / 2 == (55.5, 111))
            self.assert_(v ** Vector(2,3) == [12321, 10941048])
            self.assert_(v + [-11, 78] == Vector(100, 300))
            self.assert_(v / [10,2] == [11.1,111])

        def testReverseMath(self):
            v = Vector(111,222)
            self.assert_(1 + v == Vector(112,223))
            self.assert_(2 - v == [-109,-220])
            self.assert_(3 * v == (333,666))
            self.assert_([222,888] / v == [2,4])
            self.assert_([111,222] ** Vector(2,3) == [12321, 10941048])
            self.assert_([-11, 78] + v == Vector(100, 300))
        ...
        def testAngles(self):
            ...
            self.assert_((v - v2).length &lt, .00001)
            self.assertEqual(v.length, v2.length)
            v2.rotate(300)
        ...
        def testInplace(self):
            inplace_vec = Vector(5, 13)
            inplace_ref = inplace_vec
            inplace_src = Vector(inplace_vec)
            inplace_vec *= .5
            inplace_vec += .5
            inplace_vec /= (3, 6)
            inplace_vec += Vector(-1, -1)
